    ...
    <table>
       ...
       @if(count($data) >0)
            ...
            <tr>
                ...
                <td colspan="2">
                    <div>
                    <a class="btn btn-sm btn-primary" href="{{ route('billappeal.storebill',$v->ration)}}">Appeal Bill</a>
                    </div>
                </td>
            </tr>
            @endforeach
...
<a  class="btn btn-primary" href="{{ route('appealbill.gen')}}">Generate Bill</a>
</div>
</body>
</html>
