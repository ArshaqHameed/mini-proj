...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('New Application') }}</div>
                <div class="card-body">
                        {{--// @if(count($errors) >0 )
                    ...
                    <form method="post" action="{{ route('newapk.store') }}" autocomplete="off">
                            @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ration" type="text" class="form-control{{ $errors->has('ration') ? ' is-invalid' : '' }}" name="ration" value="{{ old('ration') }}" required autofocus>
                       ...
                       {{-- // <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="gender" name="gender" type="radio" value="male" style="margin-left:30px;margin-top:3px;">Male
                                <input id="gender" name="gender" type="radio" value="female" style="margin-left: 50px">Female
                                <input id="gender" name="gender" type="radio" value="trans" style="margin-left: 50px">Transgender
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="age" type="number" min="15" class="form-control @error('age') is-invalid @enderror" name="age"   placeholder="Select your Age :">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="mobile" type="text" class="form-control @error('mobile') is-invalid @enderror" name="mobile"   placeholder="Mobile Number :">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                    <select name="head" class="form-control input-md">
                                        ...
                                        <option value="yes" name="head">Yes</option>
                                        <option value="no" name="head">No</option>
                                    </select>
                                @if($errors->has('head'))
                                    <span class="text-danger" role="alert">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="housename" type="text" class="form-control @error('housename') is-invalid @enderror" name="housename"   placeholder="Enter Applicant House Name :">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="taluk" type="text" class="form-control @error('taluk') is-invalid @enderror" name="taluk" placeholder="Enter Applicant Taluk Name :">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="village" type="text" class="form-control @error('village') is-invalid @enderror" name="village"   placeholder="Enter Applicant Village Name :">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="panchayath" type="text" class="form-control @error('panchayath') is-invalid @enderror" name="panchayath"   placeholder="Enter Applicant Panchayath Name :">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nofamily" type="text" class="form-control @error('nofamily') is-invalid @enderror" name="nofamily"   placeholder="Select Number of Family Members :">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="adhar" type="text" class="form-control @error('adhar') is-invalid @enderror" name="adhar"   placeholder="Enter Aadhar Number :">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="account" type="text" class="form-control @error('account') is-invalid @enderror" name="account"   placeholder="Bank Account Number :">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ifsc" type="text" class="form-control @error('ifsc') is-invalid @enderror" name="ifsc"   placeholder="IFSC Code :">
                        ...
                        <div class="form-group row mb-2" >
                            <div class="col-lg offset-lg-4" >
                                <button type="submit" id="register" style="padding: 9px 80px;" class="btn btn-primary">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
